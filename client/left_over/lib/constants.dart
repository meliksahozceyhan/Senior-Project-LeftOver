...
const bPrimaryColor = Color(0xFF212f45);
const bExclamationColor = Color(0xFF006466);
const bgreen = Color(0xFF2a9d8f);
const bGrayColor = Color(0xFF7f7f7f);

const bOrange = Color(0xFFE76F51);
const bTextColorLight = Color(0xFFd3d3d3);
const bDarkBlue = Color(0xFF264653);
...
const navBlueColor = Color(0xff3f425c);
